...
clear obj_PID_panda_cascade_masses
...
complete_results_masses_cascade = cell(2, 8);
...
complete_results_masses_cascade{1,8} = {results_masses_explore};
complete_results_masses_cascade{2,8} = {results_masses};
...
for dof = 7:-1:1
    ...
    func =  @(x_vars)(obj_PID_panda_cascade_masses(x_vars,const,estimated_masses_complete));
    initial_X = [];
    clear objBO; 
   ...
   %% FIRST PHASE: EXPLORATION
    ...
    complete_results_masses_cascade{1,dof} = {results_explore};
    complete_results_masses_cascade{2,dof} = {results};
...
const.kdvect = kdvect;
dummy_x_var = table();
opt_cost = obj_PID_panda_cascade_masses(dummy_x_var, const,estimated_masses_complete);
...
file_name = sprintf('complete_results_masses_cascade_%d_%d_%d_%d_%d_%d_%d_%d_%d_%d_%s_%s_aw.mat', ...
...
save(file_name, 'complete_results_masses_cascade');