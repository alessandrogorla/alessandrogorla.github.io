...
import createImageIcon from "./ImageIcon";
import {
   SiPython,
   SiJavascript,
   SiTypescript,
...
import matalabLogo from "@assets/logos/Matlab_icon.png";
import solidworksLogo from "@assets/logos/solidworks.png";
import inventorLogo from "@assets/logos/inventor.webp";
import solidedgeLogo from "@assets/logos/solidedge.png";
import catiaLogo from "@assets/logos/catia.png";
...
const SKILL_ICONS: Record<string, SkillIcon> = {
   ...
   MATLAB: { Icon: createImageIcon(matalabLogo, "MatlabIcon"), color: "#E16737" },
   SolidWorks: { Icon: createImageIcon(solidworksLogo, "SolidWorksIcon"), color: "#FF0000" },
   Inventor: { Icon: createImageIcon(inventorLogo, "InventorIcon"), color: "#FF0000" },
   SolidEdge: { Icon: createImageIcon(solidedgeLogo, "SolidEdgeIcon"), color: "#FF0000" },
   CATIA: { Icon: createImageIcon(catiaLogo, "CatiaIcon"), color: "#FF0000" },
   ...
   "Time Management": { Icon: IoIosTimer, color: BLUE },
