...
import bachelorThesis from "@assets/projects/bachelor-thesis.png";
import omaTieRods from "@assets/projects/oma-tie-rods.png";
import railWheel from "@assets/projects/rail-wheel.png";
import harbourCrane from "@assets/projects/crane_moving_load.gif";
import ThermalRefrigeratorROM from "@assets/projects/ROM.gif";
import LinearElasticity from "@assets/projects/FOMROMDIFF.png";
...
const COVER_BY_ID: Record<number, ProjectCover> = {
   ...
   // Academic projects
   100: { kind: "image", src: bachelorThesis }, // Bachelor Thesis
   101: { kind: "image", src: omaTieRods }, // OMA Tie-Rods
   102: { kind: "image", src: railWheel }, // Rail wheel analysis
   103: { kind: "image", src: harbourCrane }, // Harbour crane FEA
   104: { kind: "image", src: ThermalRefrigeratorROM }, // Thermal Refrigerator ROM
   105: { kind: "image", src: LinearElasticity }, // Linear Elasticity ROM
